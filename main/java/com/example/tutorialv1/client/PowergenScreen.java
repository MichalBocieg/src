package com.example.tutorialv1.client;

import com.example.tutorialv1.TutorialV1;
import com.example.tutorialv1.blocks.PowergenContainer;
...
public class PowergenScreen extends AbstractContainerScreen<PowergenContainer> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(TutorialV1.MODID, "textures/gui/powergen_gui.png");
