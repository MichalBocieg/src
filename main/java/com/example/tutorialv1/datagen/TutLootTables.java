...
public class TutLootTables extends BaseLootTableProvider {
    ...
    protected void addTables() {
        ...
        lootTables.put(Registration.PGEN.get(), createStandardTable("pgen", Registration.PGEN.get(), Registration.PGEN_BE.get()));
        ...
        lootTables.put(Registration.KUPA_ORE_OVERWORLD.get(), createSilkTouchTable("kupa_ore_overworld", Registration.KUPA_ORE_OVERWORLD.get(), Registration.RAW_KUPA_CHUNK.get(), 2, 2));
        lootTables.put(Registration.KUPA_ORE_NETHER.get(), createSilkTouchTable("kupa_ore_nether", Registration.KUPA_ORE_NETHER.get(), Registration.RAW_KUPA_CHUNK.get(), 2, 2));
        lootTables.put(Registration.KUPA_ORE_END.get(), createSilkTouchTable("kupa_ore_end", Registration.KUPA_ORE_END.get(), Registration.RAW_KUPA_CHUNK.get(), 2, 2));
        lootTables.put(Registration.KUPA_ORE_DEEPSLATE.get(), createSilkTouchTable("kupa_ore_deepslate", Registration.KUPA_ORE_DEEPSLATE.get(), Registration.RAW_KUPA_CHUNK.get(), 2, 2));
    }
}
